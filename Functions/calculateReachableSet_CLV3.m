function [allSolutions, bestSol] = calculateReachableSet_CLV3(sys, sys_1, sys_2, F, settingsSolver, settings)
...
for alpha_zeta = sys.alpha_zeta_vals
    ...
    currentSol.P_zeta           = inv(currentSol.Y_zeta);
    ...
    currentSol.obj              = value(obj);
    currentSol.traceY           = trace(value(Y_zeta));
    currentSol.logdetP          = -logdet(currentSol.P_zeta);
